...
// pragma Singleton requires QtObject root.
// Timer/Process need Item's default `data` property, so they live in an inner Item.
QtObject {
    id: root
    ...
    // Inner Item hosts the polling infrastructure (Timer + Processes)
